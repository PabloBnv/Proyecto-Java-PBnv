...
public class CadenaApp {
    ...
    public static void main(String[] args)  {
        ...
        System.out.println("**************************************");
        System.out.println("*                                    *");
        System.out.println("*             Cadena APP             *");
        System.out.println("*                                    *");
        System.out.println("**************************************");

        System.out.println("    Bienvenido al portal Cadena APP");

        try (Scanner leer = new Scanner(System.in)) {
            CadenaServicio cs = new CadenaServicio();
            
           
            Cadena c = cs.pedirFrase();
            ...
            Cadena nc= cs.pedirFrase();
            cs.compararLongitud(c,nc);
